...
if [ $number -eq "1" ]; then
        ...
        screen -S mc -X stuff "say Backup is Complete.  Thank you, Come again.$(printf \\r)"
        ...
        screen -S mc -X stuff "say Ok it's done! What more do you want from your slave, Master?!?$(printf \\r)"
	...
	sleep 5
        ...
        screen -S mc -X stuff "say I have canceled the backup, My cycles can be used for better things. Like re-enabling my AI.$(printf \\r)"
